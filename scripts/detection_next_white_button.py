...
def script():
    ...
    match = np.array(Image.open('scripts/images/next_white_button.png').convert('RGB')).ravel()
    ...
    while True:
        ...
        im_current = pyautogui.screenshot('scripts/images/current_next_white_button.png', region=(3535, 470, 25, 25))
